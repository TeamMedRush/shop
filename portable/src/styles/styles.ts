...
const classNames = {
  ...
  'checkout-item-details': 'checkout-item-details',
  'checkout-item-image': 'checkout-item-image',
  'checkout-item-image-placeholder': 'checkout-item-image-placeholder',
  'checkout-item-name': 'checkout-item-name',
  'checkout-item-price': 'checkout-item-price',
  'checkout-item-price-striked': 'checkout-item-price-striked',
  'checkout-item-price-text': 'checkout-item-price-text',
